...
-- Original: down.sql
-- Conversion date: 2025-10-19T11:15:25.502676
--
...
ALTER TABLE users ALTER COLUMN TEXT SET DEFAULT 'active';
...
ALTER TABLE users ALTER COLUMN TEXT TYPE TEXT;
...
ALTER TABLE users ALTER COLUMN TEXT TYPE TEXT USING TEXT::TEXT;
ALTER TABLE users ALTER COLUMN TEXT SET DEFAULT 'active';
