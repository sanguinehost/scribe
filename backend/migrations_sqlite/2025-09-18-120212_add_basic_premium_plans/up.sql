...
('basic',
 ...
 '{"daily_messages": 100, "models": ["gemini-2.5-flash", "gemini-2.5-flash-lite"], "priority_support": false}',
...
('premium',
 ...
 '{"daily_messages": 200, "models": ["gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro"], "priority_support": true}',
 CURRENT_TIMESTAMP,                                 -- created_at
 CURRENT_TIMESTAMP                                  -- updated_at
)
