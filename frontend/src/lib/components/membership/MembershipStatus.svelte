	...
	<div class="membership-status {compact ? 'compact' : 'full'}">
		...
		{:else}
			...
			{#if !compact && getUpgradeRecommendation()}
				<div class="mt-3 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
					<div class="flex items-center justify-between">
			...
			{#if isTrialing && !compact}
				<div class="mt-3 p-3 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg border border-yellow-200 dark:border-yellow-800">
					<div class="flex items-center justify-between">
