...
pub mod db {
    ...
    pub async fn create_test_character(
        ...
        let new_character_payload = NewCharacter {
            ...
            description: Some(
                format!("Test description for {name_clone_for_payload}").into_bytes().into(),
            ),
            greeting: Some(format!("Test greeting for {name_clone_for_payload}").into_bytes().into()),
            example_dialogue: Some(
                format!("Test example dialogue for {name_clone_for_payload}").into_bytes().into(),
            ),
            visibility: Some("private".to_string()),
            character_version: Some("2.0".to_string()),
            spec: "test_spec_v2.0".to_string(),
            spec_version: "2.0".to_string(),
            persona: Some(format!("Test persona for {name_clone_for_payload}").into_bytes().into()),
            world_scenario: Some(
                format!("Test world scenario for {name_clone_for_payload}").into_bytes().into(),
            ),
            avatar: None,
            chat: None,
            created_at: Some(now),
