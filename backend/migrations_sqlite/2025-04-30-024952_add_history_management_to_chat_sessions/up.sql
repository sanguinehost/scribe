...
-- Original: up.sql
-- Conversion date: 2025-10-19T11:15:25.499037
--
-- IMPORTANT: Review warnings below and verify functionality
-- ================================================================

-- Your SQL goes here
ALTER TABLE chat_sessions ADD COLUMN history_management_strategy TEXT NOT NULL DEFAULT 'none';
ALTER TABLE chat_sessions ADD COLUMN history_management_limit INTEGER NOT NULL DEFAULT 4096;
