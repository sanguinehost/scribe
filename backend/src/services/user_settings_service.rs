                ...
                Some(_) => {
                    ...
                    let settings = target
                        .select((
                            ...
                            user_settings::default_thinking_budget,
                            user_settings::default_enable_code_execution,
                    ...
                    let response = UserSettingsResponse {
                        ...
                        default_thinking_budget: settings.8,
                        default_thinking_level: None,
                        default_enable_code_execution: settings.9,
        ...
        crate::db::with_conn(pool, move |conn| {
            ...
            diesel::update(user_settings::table.filter(user_settings::id.eq(settings_id)))
                .set((
                    ...
                    user_settings::default_thinking_budget
                        .eq(update_request.default_thinking_budget),
                    user_settings::default_enable_code_execution
                        .eq(update_request.default_enable_code_execution),
                    user_settings::default_context_total_token_limit
