...
/// Tactical plan generated by the Tactical Agent's planning phase
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TacticalPlan {
    ...
    pub phase_3_atomic: bool,
}

/// Individual action in a tactical plan
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TacticalAction {
    pub id: String,
    pub name: String, // Tool name from UnifiedToolRegistry
    pub parameters: serde_json::Value, // Dynamic parameters based on tool
