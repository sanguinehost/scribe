...
-- Original: up.sql
-- Conversion date: 2025-10-20T19:54:56.902749
--
...
ALTER TABLE credit_transactions ADD COLUMN expires_at DATETIME;
...
-- Optimizes: SELECT SUM(amount) WHERE user_id = ? AND (expires_at IS NULL OR expires_at > CURRENT_TIMESTAMP)
