 ...
 * Root layout loader
 *
 * IMPORTANT: This function should NOT contain blocking await calls.
 * All desktop initialization is now handled in +layout.svelte's onMount
 * to prevent UI freezing while waiting for API responses.
 */
export const load: LayoutLoad = async () => {
	// Return immediately - desktop init happens client-side in +layout.svelte
	return {};
};
