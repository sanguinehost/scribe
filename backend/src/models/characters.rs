...
impl Character {
    ...
    fn build_client_character(
        ...
        CharacterDataForClient {
            ...
            extensions: self.extensions.or_else(|| Some(serde_json::json!({}))),
            ...
            usage_hints: self.usage_hints.or_else(|| Some(serde_json::json!({}))),
            ...
            lorebook_id: lorebook_ids.first().copied(), // For backward compatibility
            lorebook_ids,
        }
    }
}
...
mod tests {
    ...
    async fn test_description_encryption_and_decryption_via_client_conversion() {
        ...
        let client_data_no_desc = char_no_desc
            .clone()
            .into_decrypted_for_client(Some(&dek), vec![])
            .unwrap();
    ...
    async fn test_into_decrypted_for_client() {
        ...
        // Without DEK
        let client_data_without_dek = character.into_decrypted_for_client(None, vec![]).unwrap();
        assert_eq!(
