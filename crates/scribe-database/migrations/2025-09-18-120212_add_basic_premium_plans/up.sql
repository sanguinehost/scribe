...
('basic',
 ...
 '{"daily_messages": 100, "models": ["gemini-2.5-flash", "gemini-2.5-flash-lite"], "priority_support": false}'::jsonb,
 NOW(),                                 -- created_at
 NOW()                                  -- updated_at
),
...
('premium',
 ...
 '{"daily_messages": 200, "models": ["gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro"], "priority_support": true}'::jsonb,
 NOW(),                                 -- created_at
 NOW()                                  -- updated_at
)
