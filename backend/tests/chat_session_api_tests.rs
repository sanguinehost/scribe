    ...
    let character: DbCharacter = character_conn_obj
        .interact(move |actual_pg_conn| {
            let new_character_values = NewCharacter {
                ...
                alternate_greetings: DbStringArray::default(),
                nickname: None,
                creator_notes_multilingual: None,
                source: DbStringArray::default(),
                group_only_greetings: DbStringArray::default(),
                creation_date: None,
                ...
                system_tags: DbStringArray::default(),
                token_budget: None,
                usage_hints: None,
                user_persona: None,
