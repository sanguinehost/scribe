...
-- Original: down.sql
-- Conversion date: 2025-10-19T11:15:25.491076
--
...
-- Change relevant BLOB fields back to TEXT for characters table
-- Note: This is potentially lossy if BLOB data is not valid UTF-8
