...
pub type GenerationDataWithUnsavedUserMessage = (
    ...
    Option<Vec<crate::DbUuid>>, // 2: active_lorebook_ids_for_search
    Option<crate::DbUuid>,   // 3: session_character_id (NEW) - Now optional for non-character chat modes
    Option<String>, // 4: raw_character_system_prompt (NEW - from character_db.system_prompt)
    Option<crate::DbBigDecimal>, // 5: temperature (was 4)
    Option<i32>,    // 6: max_output_tokens (was 5)
    Option<crate::DbBigDecimal>, // 7: frequency_penalty (was 6)
    Option<crate::DbBigDecimal>, // 8: presence_penalty (was 7)
    Option<i32>,    // 9: top_k (was 8)
    Option<crate::DbBigDecimal>, // 10: top_p (was 9)
    ...
    Option<crate::DbUuid>,   // 22: player_chronicle_id (NEW - for narrative processing)
