...
ALTER TABLE subscriptions ADD COLUMN soft_limit_override INTEGER;
...
-- SQLite Note: CREATE OR REPLACE FUNCTION is PostgreSQL syntax, not supported
-- CREATE OR REPLACE FUNCTION update_updated_at_column()... -- Removed: SQLite does not support PL/pgSQL

-- Create triggers for updated_at
-- SQLite Note: Triggers have different syntax - must include BEGIN...END block
...
CREATE TRIGGER update_daily_usage_tracking_updated_at
    ...
    FOR EACH ROW
BEGIN
    UPDATE daily_usage_tracking SET updated_at = CURRENT_TIMESTAMP WHERE id = NEW.id;
END;
...
CREATE TRIGGER update_credit_packages_updated_at
    ...
    FOR EACH ROW
BEGIN
    UPDATE credit_packages SET updated_at = CURRENT_TIMESTAMP WHERE id = NEW.id;
END;
