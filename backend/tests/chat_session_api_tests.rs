    ...
    let character: DbCharacter = character_conn_obj
        .interact(move |actual_pg_conn| {
            let new_character_values = NewCharacter {
                ...
                alternate_greetings: Some(DbStringArray::default()),
                nickname: None,
                creator_notes_multilingual: None,
                source: Some(DbStringArray::default()),
                group_only_greetings: Some(DbStringArray::default()),
                creation_date: None,
                ...
                system_tags: Some(DbStringArray::default()),
                token_budget: None,
                usage_hints: None,
                user_persona: None,
...
async fn test_create_chat_session_with_empty_first_mes() -> Result<(), AnyhowError> {
    ...
    let new_character = DbCharacter {
        ...
        system_prompt: None,
        post_history_instructions: None,
        tags: Some(DbStringArray::default()),
        creator: None,
        character_version: None,
        alternate_greetings: Some(DbStringArray::default()),
        nickname: None,
...
async fn create_test_lorebook(
    ...
    let new_lorebook = NewLorebook {
        ...
        created_at: Utc::now().into(), // Corrected to Option<DateTime<Utc>>
        updated_at: Utc::now().into(), // Corrected to Option<DateTime<Utc>>
    };
