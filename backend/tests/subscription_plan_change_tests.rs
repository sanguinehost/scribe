    ...
    async fn test_immediate_upgrade_basic_to_premium() -> Result<(), AppError> {
        ...
        conn.interact(move |conn| {
            ...
            let new_subscription = NewSubscription {
                ...
                last_credit_grant: Some(Utc::now()),
                paddle_sync_attempted: false,
                first_payment_date: Some(Utc::now()),
    ...
    async fn test_upgrade_cancels_pending_downgrade() -> Result<(), AppError> {
        ...
        conn.interact(move |conn| {
            ...
            let new_subscription = NewSubscription {
                ...
                status: "active".to_string(),
                current_period_start: Utc::now(),
                current_period_end: Utc::now() + chrono::Duration::days(15),
                cancel_at_period_end: Some(false),
                trial_end: None,
                credits_allocated_this_period: Some(true),
                soft_limit_override: None,
                ...
                scheduled_change_date: Some(Utc::now() + chrono::Duration::days(15)),
            };
        ...
        for i in 0..3 {
            ...
            conn.interact(move |conn| {
                ...
                let new_subscription = NewSubscription {
                    ...
                    scheduled_change_date: Some(Utc::now() - chrono::Duration::hours(1)), // Due 1 hour ago
                };
