...
pub mod default_settings; // Add the default settings module
...
pub use self::default_settings::{handle_default_settings_action, apply_default_settings_to_session};